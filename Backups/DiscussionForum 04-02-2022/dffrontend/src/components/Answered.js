...
function Answered() {
    ...
    // Logic for tags when tags are not updated
    // function setTagsForAnswerWhenNotUpdated(){
    //     const arr = tagsForAnswerUpdate;
    //     const res = arr.map(value => ({value}));
    //     setTagsForAnswer(res)
    // }
    ...
    function openUpdateModal(ansId, answer, tagsForAnswer){
        ...
        // console.log("Type of tagsForAnswer: " + typeof tagsForAnswer)
    ...
    async function updateAnswer(e) {
        ...
        try{
            ...
            //     const arr = tagsForAnswerUpdate;
            //     const res = arr.map(value => ({value}));
            //     setTagsForAnswerUpdate(res)
            // }
            //let tagsForAnswer = tagsForAnswerUpdate.map(a => a.value);
            console.log(wasTagUpdated)
            if(wasTagUpdated === false) {
            ...
            if(wasTagUpdated === true) {
                ...
                // let tagsForAnswer = getTagsForAnswer
                const answerData = {answer, tagsForAnswer};
