    ...
    return (
      <Layout>
        <div className="container-fluid-main">
          ...
          <div className="Teacher-Head-Class name">
            <Tinput
          ...
          <div className="Teacher-Courses-Buttons-head">
            ...
            <div className="Teacher-Courses-Buttons">
              <button
                onClick={() => this.categoryHandler("Web Development")}
              ...
              <button
                ...
                onClick={() => this.categoryHandler("Web Designing")}
              >
                {" "}
                Designing
              </button>
          ...
          <div className="Teacher-Head-Class">
            <Tinput
              label={this.state.Form.url.label}
              rows={this.state.Form.url.rows}
              cols={this.state.Form.url.cols}
              placeholder={this.state.Form.url.placeholder}
              changed={(event) => this.inputchangeHandler(event, "url")}
            />
          </div>
